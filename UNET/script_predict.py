...
path = "/home/uesr/Desktop/Cityscapes/online/"
'''
# our CLI parser
parser = argparse.ArgumentParser()
parser.add_argument("--datadir", type=str, default="/home/uesr/Desktop/Cityscapes/", help="directory of images")
...
img_data = torchvision.datasets.ImageFolder(args.datadir, transform=transform_image)
img_batch = torch.utils.data.DataLoader(img_data, batch_size=16, shuffle=False, num_workers=4)
print(img_data)
